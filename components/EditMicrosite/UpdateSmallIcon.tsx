...
import { icon, newIcons, smallIconData } from "@/util/data/smartsiteIconData";
...
const UpdateSmallIcon = ({ iconDataObj, setOpen }: any) => {
  ...
  useEffect(() => {
    if (iconDataObj) {
      ...
      // setSelectedIconByLivePreview(smallIconData[iconDataObj.data.iconName]);
          ...
          <div>
            ...
            <form onSubmit={handleSmallIconFormSubmit}>
              ...
              <div className="flex justify-end mt-3">
                <EditMicrositeBtn
                  type="submit"
                  className="!gap-1 border-gray-400 !w-56 justify-center"
                >
                  {isLoading ? (
                    <>
