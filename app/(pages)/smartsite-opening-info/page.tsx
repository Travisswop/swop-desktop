"use client";
import CreateYourSmartsiteModal from "@/components/modal/CreateYourSmartsiteModal";
      ...
      <div className="py-24">
        ...
        <div className="bg-white p-8 w-[80%] 2xl:w-[74%] mx-auto">
          ...
          <form action="" className="grid grid-cols-2 gap-6">
            ...
            <div className="flex items-center bg-gray-100 rounded-lg">
              <div className="py-3 px-4 border-r border-gray-300">
                <Image alt="website icon" src={website_link} className="w-7" />
              </div>
              <input
                type="text"
                name="website"
